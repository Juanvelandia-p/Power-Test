...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ruta a las imágenes
    const logoOriginal = 'resources/logos/Logo lightened actualizado.webp'; // Ajusta el nombre del archivo
    const logoHover = 'resources/logos/Logo completo darkned.webp'; // Ajusta el nombre del archivo
